...
namespace retro::assets
{
    ...
    {
        RT_PROFILE_SECTION("assets_manager::get_asset_pack");
        RT_ASSERT_MSG(m_asset_packs.contains(asset_pack_name), "Unknown asset pack!");
        return m_asset_packs.at(asset_pack_name);
    }

    void asset_manager::register_asset_pack(const std::shared_ptr<asset_pack> &asset_pack)
    {
        RT_PROFILE_SECTION("assets_manager::register_asset_pack");
    ...
    {
        RT_PROFILE_SECTION("assets_manager::register_asset");
        m_assets[asset_object->get_metadata().type].push_back(asset_object);
    }

    void asset_manager::deserialize_packs()
    {
        RT_PROFILE_SECTION("assets_manager::deserialize_packs");
    ...
    {
        RT_PROFILE_SECTION("assets_manager::serialize_packs");
