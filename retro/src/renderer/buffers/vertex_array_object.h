...
namespace retro::renderer
{
    ...
    public:
        ...
        const std::shared_ptr<vertex_buffer_object>& get_index_buffer() const { return m_index_buffer;  }

        void bind();
        void un_bind();

        void add_vertex_buffer(const std::shared_ptr<vertex_buffer_object> &vertex_buffer);
        void set_index_buffer(const std::shared_ptr<vertex_buffer_object> &index_buffer);
