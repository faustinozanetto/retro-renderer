...
#define RT_PROFILE_TAG(y, x) ZoneText(x, strlen(x))
#define RT_PROFILE_LOG(text, size) TracyMessage(text, size)
#define RT_PROFILE_VALUE(text, value) TracyPlot(text, value)
...
#define RT_PROFILE_TAG(y, x)
#define RT_PROFILE_LOG(text, size)
#define RT_PROFILE_VALUE(text, value)
