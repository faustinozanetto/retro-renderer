...
namespace retro::editor
{
	...
	std::pair<bool, size_t> editor_actor_physics_static_actor_component_panel::get_actor_component_details()
	{
		...
		bool has_component = current_scene->get_actors_registry()->any_of<scene::physics_static_actor_component>(editor_main_layer::s_selected_actor);
	...
	void editor_actor_physics_static_actor_component_panel::on_render_component_details()
	{
		...
		auto &physics_static_actor_component = current_scene->get_actors_registry()->get<scene::physics_static_actor_component>(
