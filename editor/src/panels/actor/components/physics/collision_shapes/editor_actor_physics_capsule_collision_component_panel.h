...
{
    class editor_actor_physics_capsule_collision_component_panel : public editor_actor_component_panel
    {
    public:
        editor_actor_physics_capsule_collision_component_panel();
