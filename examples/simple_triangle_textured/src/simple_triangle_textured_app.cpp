...
void simple_triangle_textured_app::on_handle_event(retro::events::base_event& event)
{
}

bool simple_triangle_textured_app::on_window_resize(retro::events::window_resize_event& resize_event)
{
