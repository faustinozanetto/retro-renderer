...
{
    editor_graph_node_material::editor_graph_node_material(const std::shared_ptr<renderer::material>& value) : editor_graph_node()
    {
        graph_node * node = new graph_node("Material Output", editor_graph_panel::get_next_id());
        // Parameters inputs
        // Albedo
        {
